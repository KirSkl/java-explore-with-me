--DROP TABLE IF EXISTS users CASCADE; --Раскомментировать для многократного тестирования
...
(
    ...
    CONSTRAINT fk_comments FOREIGN KEY (author_id) REFERENCES users (id) ON DELETE CASCADE
);
